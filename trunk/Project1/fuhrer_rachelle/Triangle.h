...
protected:
	...
	void calcPluckerCoords(Vector3 linePt, Vector3 lineDir, Vector3 pluckerCoordsOut[2]);
	float permutedInnerProduct(Vector3 pluckerR[2], Vector3 pluckerS[2]);
};
