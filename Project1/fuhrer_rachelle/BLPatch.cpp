...
BLPatch::uvCoeff()
{
	Vector3 * uvCoeff = new Vector3(pointA() - pointB() + pointC() - pointD());
	return *uvCoeff;
}
...
BLPatch::uCoeff()
{
	Vector3 * uCoeff = new Vector3(-pointA() + pointB());
	return *uCoeff;
}
...
BLPatch::vCoeff()
{
	Vector3 * vCoeff = new Vector3(-pointA() + pointD());
	return *vCoeff;	
}
...
BLPatch::constCoeff()
{
	Vector3 * constCoeff = new Vector3(pointA());
	return *constCoeff;
}
